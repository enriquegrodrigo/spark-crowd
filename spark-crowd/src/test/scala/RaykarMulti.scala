...
class RaykarMultiTest extends fixture.FlatSpec with Matchers {
  ...
  "RaykarMulti" should "obtain the expected result on test data" in { f => 
    ...
    assert(fis2 ===  0.9827296, "Result on the second example") 
